...
Codex CLI functions as an MCP client that allows the Codex CLI and IDE extension to connect to MCP servers on startup. See the [`MCP documentation`](https://developers.openai.com/codex/mcp) for details.
